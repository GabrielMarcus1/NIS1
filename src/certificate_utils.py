...
def create_certificate(public_key):
    ...
    subject = x509.Name(
        [
            ...
            x509.NameAttribute(NameOID.STATE_OR_PROVINCE_NAME, "CAPE TOWN"),
            x509.NameAttribute(NameOID.LOCALITY_NAME, "UCT"),
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, "Computer Science Honours"),
            x509.NameAttribute(NameOID.COMMON_NAME, "NIS"),
        ]
    )
    ...
    cert = cert.add_extension(
        x509.SubjectAlternativeName([x509.DNSName("UCT.com")]),
        critical=False,
    )
